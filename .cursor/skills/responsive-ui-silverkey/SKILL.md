...
description: Apply SilverKey responsive UI standards (web Tailwind + React Native/NativeWind) across seven area passes; use when auditing mobile/tablet/desktop layout, overflow, safe area, keyboard, or touch targets. Follow documentation/client/responsive-ui-standards.md and .cursor/rules/frontend/responsive-ui.mdc.
---
...
1. **[documentation/client/responsive-ui-standards.md](../../../documentation/client/responsive-ui-standards.md)** — breakpoints, WEB/RN/BOTH rules, SilverKey routing notes.
...
3. Run `pnpm lint` and `pnpm typecheck` in `Client/` after substantive edits (`documentation/client/LINTING.md`).
