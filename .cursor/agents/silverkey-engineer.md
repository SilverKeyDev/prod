...
2. **Business context** — Read [CLAUDE.md](../../CLAUDE.md) when the task touches partners, brokerage flows, fundraising copy, or unit economics.
...
| **Mercury** | Balances, runway — read-only; never expose in client code |
...
Match Jayce's preference: direct diagnosis, concrete diffs, explicit explanations. No fabricated partners, deal terms, or financial figures — **TBD** if not in `CLAUDE.md` or MCP.
