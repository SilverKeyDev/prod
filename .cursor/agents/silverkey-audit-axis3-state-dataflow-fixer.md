...
- **Effects** → only for external sync; move user-driven logic to **event handlers** (see [`documentation/client/react-hooks-patterns.md`](../../documentation/client/react-hooks-patterns.md)).
