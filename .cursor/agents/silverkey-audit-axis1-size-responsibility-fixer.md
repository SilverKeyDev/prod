...
- **Thin app:** Move business logic, heavy UI, and hooks **out of** `Client/apps/**` into `Client/packages/features/`, `Client/packages/hooks/`, `Client/packages/utils/`, or `Client/packages/schemas/` as appropriate ([`documentation/architecture/thin-app-architecture.md`](../../documentation/architecture/thin-app-architecture.md)).
...
- Rubric: [`documentation/architecture/patterns/react-component-audit-rubric.md`](../../documentation/architecture/patterns/react-component-audit-rubric.md)
