...
export const userApi = {
   ...
   */
  getProfile: (): Promise<UserResponse> => apiGet<UserResponse>('/api/v1/user/profile'),
   ...
   */
  getAssignedAgent: (): Promise<{ success: boolean; data?: unknown; message?: string }> =>
    apiGet<{ success: boolean; data?: unknown; message?: string }>('/api/v1/user/assigned-agent'),

  /**
   * Get client list for agents
   */
  getClientList: (): Promise<{ success: boolean; clients?: unknown[]; message?: string }> =>
    apiGet<{ success: boolean; clients?: unknown[]; message?: string }>('/api/v1/agent/clients'),
