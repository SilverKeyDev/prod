...
import type { ApiResponse, FetchJsonOpts, RetryOpts, ApiRequestOptions } from '../../schemas/api';
...
export async function apiRequest<T = unknown>(
  ...
  const base = normalizeBase(baseUrl ?? getEnvVar('VITE_API_BASE_URL', '').replace(/\/+$/, ''));
