...
export function usePlaidIntegration() {
  ...
  const { assetReports, assetReportsLoading, assetReportsError } = usePlaidAssetReports();
  const { statements, statementsLoading, statementsError } = usePlaidStatements();
  ...
  const setPlaidItemsLoading = usePlaidStore((state) => state.setPlaidItemsLoading);
  const setAssetReportsLoading = usePlaidStore((state) => state.setAssetReportsLoading);
  const setStatementsLoading = usePlaidStore((state) => state.setStatementsLoading);
  const setPlaidItemsError = usePlaidStore((state) => state.setPlaidItemsError);
  const setAssetReportsError = usePlaidStore((state) => state.setAssetReportsError);
  ...
  const memoizedSetAssetReports = useCallback(setAssetReports, [setAssetReports]);
  const memoizedSetStatements = useCallback(setStatements, [setStatements]);
  const memoizedSetPlaidItemsLoading = useCallback(setPlaidItemsLoading, [setPlaidItemsLoading]);
  const memoizedSetAssetReportsLoading = useCallback(setAssetReportsLoading, [setAssetReportsLoading]);
  const memoizedSetStatementsLoading = useCallback(setStatementsLoading, [setStatementsLoading]);
  const memoizedSetPlaidItemsError = useCallback(setPlaidItemsError, [setPlaidItemsError]);
  const memoizedSetAssetReportsError = useCallback(setAssetReportsError, [setAssetReportsError]);
  const memoizedSetStatementsError = useCallback(setStatementsError, [setStatementsError]);
...
export function usePlaidStoreActions() {
  ...
  const setAssetReportsLoading = usePlaidStore((state) => state.setAssetReportsLoading);
  const setStatementsLoading = usePlaidStore((state) => state.setStatementsLoading);
  const setLinkTokenLoading = usePlaidStore((state) => state.setLinkTokenLoading);
  ...
  const setSelectedReportToken = usePlaidStore((state) => state.setSelectedReportToken);
