      ...
      <div className="w-full max-w-[600px] px-2 sm:px-4">
        <div className="mb-4 sm:mb-6">
          <input
            ...
            className={`h-2 w-full touch-manipulation appearance-none rounded-lg bg-beige accent-brown ${disabled ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'}`}
            disabled={disabled}
        ...
        <div className="text-center">
          <span className="text-base font-medium text-brown sm:text-lg">
