...
export function usePropertyFocus(params: {
  ...
  }, [currentPage, searchResults.length, savedHomes.length, mapFocusOnCurrentProperty]);
  ...
  }, [activeTab, searchResults.length, savedHomes.length, mapFocusOnCurrentProperty]);
}
