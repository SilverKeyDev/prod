  ...
  return (
    <button
      className={`relative text-lg font-semibold
        text-gray-400 underline decoration-gray-400 decoration-1 underline-offset-[4px]
        hover:text-gray-500 hover:decoration-gray-500
        ...
        after:bg-gray-400 after:scale-x-0 after:origin-left
        motion-safe:after:transition-transform motion-safe:after:duration-300
        hover:after:scale-x-100 hover:after:bg-gray-500
        ${className}`}
      onClick={onClick}
      title={title}
    >
