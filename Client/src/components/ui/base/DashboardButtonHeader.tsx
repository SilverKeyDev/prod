    ...
    return (
      <div className="mobile-container">
        ...
        <div
          ...
          style={{
            gridTemplateColumns: `repeat(${Math.min(TIMELINE_STEPS.length * 2 - 1, 8)}, minmax(0, 1fr))`, // steps + connecting lines, max 8 columns
          }}
        >
            ...
            return (
              <React.Fragment key={step.key}>
                ...
                <div className="flex flex-col items-center col-span-1 min-w-0">
                  ...
                  <span className="hidden sm:inline text-[10px] sm:text-xs md:text-sm lg:text-base mt-0.5 sm:mt-1 text-gray-600 capitalize select-none text-center px-0.5 sm:px-1 truncate max-w-full font-medium">
                    {step.name}
                  </span>
