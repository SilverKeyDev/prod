...
const spring: Transition = { type: "spring", stiffness: 600, damping: 35, mass: 0.7 };
...
const OnboardingHeader: React.FC<OnboardingHeaderProps> = ({
  ...
  const connectorMotion = (index: number) => {
    ...
    if (direction === "forward") {
      return {
        initial: { width: newlyCompleted ? "0%" : isCompletedNow ? "100%" : "0%" },
  ...
  const { columnGap, rowGap, showConnectors, connectorWidth, connectorMargin } = calculateConnectorLayout();
  ...
  return (
    ...
    <div className="mt-6 mb-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm mx-auto max-w-[85vw] overflow-hidden">
        ...
        <div ref={outerRef} className="w-full overflow-visible" style={{ transformOrigin: "top center" }}>
          <div style={{ transform: `scale(${scale})`, transformOrigin: "top center" }}>
            {/* Keep interior layout centered; no extra bottom margin */}
            <div className="mobile-card flex items-center justify-center py-1 sm:py-3 overflow-visible">
                  ...
                  <React.Fragment key={step.id}>
                    ...
                    <div className="flex justify-center items-center h-full relative">
                      ...
                      >
                        <AnimatePresence mode="popLayout" initial={false}>
                          {isCompleted ? (
                            <motion.span
                              ...
                              transition={newlyCompleted ? { ...t, delay: (index - prevStep) * 0.05 } : instant}
                              className="flex"
                            >
                        ...
                        <motion.span
                          ...
                          style={{ boxShadow: "0 0 0 0 rgba(0,0,0,0)", overflow: "visible" }}
                          animate={{
                            boxShadow: isActive
                    ...
                    {index < steps.length - 1 && showConnectors && (
                      ...
                      >
                        ...
                        >
                          <motion.div className="h-full bg-olive" {...connectorMotion(index)} />
                        </div>
                      </div>
                    )}
                  </React.Fragment>
    ...
    </div> // end extra top-margin wrapper
  );
};
