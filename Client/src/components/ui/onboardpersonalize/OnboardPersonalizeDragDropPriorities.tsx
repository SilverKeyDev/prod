...
interface OnboardPersonalizeDragDropPrioritiesProps {
  isEditMode: boolean;
  isLoading?: boolean;
...
const OnboardPersonalizeDragDropPriorities: React.FC<
  OnboardPersonalizeDragDropPrioritiesProps
> = ({
  isEditMode,
  isLoading = false,
  orderedSections,
...
export default OnboardPersonalizeDragDropPriorities;
