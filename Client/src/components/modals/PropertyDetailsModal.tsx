...
const PropertyDetailsModal: React.FC<PropertyDetailsModalProps> = ({
      ...
      return property.photos
        .map((photo: any) => {
          ...
          if (
            ...
            photo.mixedSources.jpeg.length > 0
          ) {
  ...
  const handleGoToZillow = () => {
    try {
      ...
      const fallbackUrl = `https://www.zillow.com/homes/${encodeURIComponent(
        property.address
      )}_rb/`;
        ...
        <div className="space-responsive-lg">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatPropertyType(
                      property.homeType || property.propertyType || ""
                    )}
                  </span>
                </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-16 h-16 rounded-full border-2 border-brown/20 flex-shrink-0 overflow-hidden bg-brown/10">
                      {property.listed_by.image_url ? (
                        <img
                          ...
                          alt={
                            property.listed_by.display_name || "Listing Agent"
                          }
                      ...
                      <div
                        className={`w-full h-full flex items-center justify-center ${
                          property.listed_by.image_url ? "hidden" : "flex"
                        }`}
                      >
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium text-brown text-lg">
                        {property.listed_by.display_name}
                      </h4>
                      ...
                      {property.listed_by.phone && (
                        <div className="flex items-center text-brown mt-2">
                          ...
                          <span>
                            {property.listed_by.phone.areacode &&
                            property.listed_by.phone.prefix &&
                            property.listed_by.phone.number
            ...
            <div>
              ...
              <div className="space-y-3">
                {property.schools && property.schools.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="text-sm text-brown/70 space-y-1">
                        ...
                        {school.studentsPerTeacher && (
                          <p>
                            Student/Teacher Ratio: {school.studentsPerTeacher}:1
                          </p>
                        )}
                        {school.isAssigned && (
                  ...
                  <div className="bg-beige/10 border border-beige/40 rounded-lg p-4">
                    <p className="text-brown/70">
                      No school information available for this property.
                    </p>
                  </div>
                )}
              </div>
          ...
          {property.features && (
            <div className="mb-8">
              ...
              <div className="bg-beige/20 border border-beige rounded-lg p-6">
                ...
                {property.image_features &&
                  !property.image_features.error &&
                  property.image_features.clean &&
                  property.image_features.clean.length > 0 && (
                    <div className="">
                      ...
                      <div className="text-brown/70 text-xs leading-relaxed">
                        {property.image_features?.clean?.map(
                          (feature, index) => (
                    ...
                    <div className="bg-beige/10 border border-beige/40 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-6">
                        ...
                        <span className="bg-olive/20 text-olive border border-olive/30 px-3 py-1 rounded-full text-sm font-medium">
                          {
                            property.property_analysis.crime_stats
                      ...
                      <div className="space-y-3 ml-2.5">
                        <div className="flex justify-start text-xs">
                          ...
                          <span className="text-olive ml-2">
                            {property.property_analysis.crime_stats.crime_rate}
                          </span>
                        </div>
                        <div className="flex justify-start text-xs">
                        ...
                        <div className="flex justify-start text-xs">
                          ...
                          <span className="text-olive ml-2">
                            {property.property_analysis.crime_stats.data_source}
                          </span>
                        </div>
                      </div>
                    </div>
                    {property.property_analysis.crime_stats.specific_concerns
                      .length > 0 && (
                      <div className="bg-beige/10 border border-beige/40 rounded-lg p-4">
                        ...
                        <div className="space-y-1">
                          {property.property_analysis.crime_stats.specific_concerns.map(
                            (concern, index) => (
                              <p key={index} className="text-sm text-brown/70">
                                {concern}
                              </p>
                            )
                          )}
                  ...
                  <div className="space-y-4">
                    <div className="bg-beige/10 border border-beige/40 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-6">
                        ...
                        <span className="bg-olive/20 text-olive border border-olive/30 px-3 py-1 rounded-full text-sm font-medium">
                          {
                            property.property_analysis.gentrification_index
                              .score
                          }
                        </span>
                      </div>
                    ...
                    {property.property_analysis.gentrification_index.indicators
                      .length > 0 && (
                      <div className="bg-beige/10 border border-beige/40 rounded-lg p-4">
                        <h4 className="font-medium text-brown mb-2">
                          Key Indicators
                        ...
                        <div className="space-y-1">
                          {property.property_analysis.gentrification_index.indicators.map(
                            (indicator, index) => (
                              <p key={index} className="text-sm text-brown/70">
                                {indicator}
                              </p>
                ...
                {property.commute_data?.error ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div className="flex flex-col justify-center h-full space-y-4">
                      {property.commute_data.travel_times &&
                      property.commute_data.travel_times.length > 0 ? (
                        property.commute_data.travel_times.map(
                          (commute, index) => {
                            const travelTimeMinutes = commute.travel_time
                              ? parseInt(commute.travel_time.replace(/\D/g, ""))
                              : null;
                        ...
                        <div className="flex items-center justify-center h-full">
                          <Card className="text-center text-brown/60">
                            <p>No important locations configured</p>
                            <p className="text-sm mt-1">
                              Set up your important locations in preferences to
                              see commute times
                            </p>
                          </Card>
                        </div>
          ...
          <div className="bg-gold/10 border border-gold/30 rounded-lg p-4">
            ...
            <div className="text-gold text-sm leading-relaxed">
              ...
              {(() => {
                const roiText =
                  property.property_analysis?.roi_explanation || "";
