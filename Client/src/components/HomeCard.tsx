...
import { usePropertyDetails, type Property } from '../hooks/usePropertyDetails';
...
export default function HomeCard({ 
  ...
  const { isLoading, selectedProperty, fetchPropertyDetails, clearSelectedProperty } = usePropertyDetails();
  ...
  const convertToProperty = (homeDesc: HomeDescription): Property => {
    return {
      ...
      price: typeof homeDesc.price === 'string' ? homeDesc.price : 
             typeof homeDesc.price === 'number' ? `$${homeDesc.price.toLocaleString()}` : 
             'Price not available',
