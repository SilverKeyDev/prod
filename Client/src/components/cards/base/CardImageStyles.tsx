...
export type ImageStyleVariant = 'default' | 'professional' | 'muted' | 'vibrant';
...
export function getImageStyleClasses(variant: ImageStyleVariant = 'professional'): string {
  const config = IMAGE_STYLE_CONFIGS[variant];
  return config.className || 'object-cover';
}

export function getImageInlineStyles(variant: ImageStyleVariant = 'professional'): React.CSSProperties {
  const config = IMAGE_STYLE_CONFIGS[variant];
  return {
...
export function getImageHoverStyles(variant: ImageStyleVariant = 'professional'): React.CSSProperties {
  const config = IMAGE_STYLE_CONFIGS[variant];
  return {
