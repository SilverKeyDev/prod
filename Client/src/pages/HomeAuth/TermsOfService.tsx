import StaticPageLayout, { Section, Paragraph, List, EmailLink } from "../../components/layout/StaticPageLayout";
  ...
  return (
    ...
    >
      ...
      <Section title="3. User Accounts">
        <Paragraph>To access certain features of the service, you may be required to create an account. You agree to:</Paragraph>
        <List>
      ...
      <Section title="4. Subscription and Billing">
        ...
        <Paragraph>We may change our prices at any time by posting notice to your account and/or on our website.</Paragraph>
      </Section>
      ...
      <Section title="8. Contact Us" isLast={true}>
        <Paragraph>
          If you have any questions about these Terms, please contact us at <EmailLink href="mailto:legal@silverkey.com">legal@silverkey.com</EmailLink>.
        </Paragraph>
      </Section>
    </StaticPageLayout>
  );
