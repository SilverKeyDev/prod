  ...
  return (
    ...
    >
      ...
      <Section title="2. Data We Collect">
        <Paragraph>We may collect, use, store, and transfer different kinds of personal data about you which we have grouped together as follows:</Paragraph>
        <List>
      ...
      <Section title="5. Your Legal Rights" isLast={true}>
        ...
        <Paragraph>If you wish to exercise any of the rights set out above, please contact us at <EmailLink href="mailto:privacy@silverkey.com">privacy@silverkey.com</EmailLink>.</Paragraph>
      </Section>
    </StaticPageLayout>
  );
}
