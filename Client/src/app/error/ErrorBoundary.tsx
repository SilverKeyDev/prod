...
import { reportError, normalizeError } from "../../core/utils/errorHandling";
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    try {
      ...
      console.warn("Failed to report error in error boundary:", reportError);
    }
  ...
  handleFeedbackSubmit = () => {
    if (this.state.feedbackMessage.trim()) {
      try {
        ...
        console.warn("Failed to report error feedback:", error);
      }
  ...
  render() {
    if (this.state.hasError) {
      ...
      const normalizedError = normalizeError(
        this.state.error || new Error("Unknown error occurred")
      );
