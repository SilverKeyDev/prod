...
export const ICON_BUTTON_VARIANT_STYLES: Record<IconButtonVariant, string> = {
  ...
  tertiary:
    "bg-accent text-white shadow-sm hover:bg-accent-hover hover:shadow active:bg-accent-hover active:shadow focus:ring-neutral-400 disabled:bg-gold-locked disabled:text-white disabled:shadow-none",
  outline:
...
/** Same frame as `BUTTON_LOADING_FRAME_CLASSES` - lighter fill per variant below. */
