...
export const INPUT_VARIANT_STYLES: Record<InputVariant, string> = {
  ...
  mobile:
    "border-border-input bg-white hover:bg-neutral-100 active:bg-neutral-100 focus:ring-neutral-400 focus:border-input-variant-focus-border touch-friendly autofill-brand",
  compact:
    "border-border-input bg-white hover:bg-neutral-100 active:bg-neutral-100 focus:ring-neutral-400 focus:border-input-variant-focus-border",
  search:
    "border-border-input bg-white hover:bg-neutral-100 active:bg-neutral-100 focus:ring-neutral-400 focus:border-input-variant-focus-border",
...
export const INPUT_ERROR_STYLES = "border-red-500 focus:border-red-500 focus:ring-red-500";
