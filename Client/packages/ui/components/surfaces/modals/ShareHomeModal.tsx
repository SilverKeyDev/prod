...
import { getShareHomeConversationId, getShareHomePropertyId } from "packages/utils/comms/share";
...
export default function ShareHomeModal({
  ...
  const getPropertyUrl = (): string | null => {
    ...
    try {
      ...
      const address =
        formatAddress(property.address as string | object | null | undefined) || "property";
      ...
      <Box className="space-y-4">
        ...
        <Box>
          ...
          <Textarea
            ...
            placeholder={`Thought you might like this home: ${propertyAddress}`}
