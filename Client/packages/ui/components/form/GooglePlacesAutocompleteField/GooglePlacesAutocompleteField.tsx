...
} from "packages/ui/components/form/AddressInput/AddressInput";

export type { AddressInputProps as GooglePlacesAutocompleteFieldProps } from "packages/ui/components/form/AddressInput/AddressInput";
