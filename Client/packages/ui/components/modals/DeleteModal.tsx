    ...
    <div className="space-responsive-sm fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="space-responsive-sm mx-4 w-full max-w-md rounded-xl bg-white">
        <div className="text-center">
          ...
          <Title size="lg" as="h3" className="space-y-responsive-xs text-gray-900">
            {title}
          </Title>
          <BodyText size="sm" muted className="space-y-responsive-md text-gray-500">
            {message}
          </BodyText>
          <div className="flex justify-center gap-4">
            <CancelButton type="button" onClick={onClose} size="md">
              {cancelText}
            </CancelButton>
            <Button type="button" variant="danger" onClick={onConfirm} size="md">
              {confirmText}
            </Button>
          </div>
        </div>
