...
export type PopoverProps = {
  ...
  children: (props: { onClose: () => void; panelId?: string }) => ReactNode;
  ...
  usePortal?: boolean;
  /** Where the panel opens relative to the trigger: "left" = panel opens to the left, "bottom" = below (default). Ignored on native. */
  side?: PopoverSide;
