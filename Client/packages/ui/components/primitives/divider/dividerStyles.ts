...
export const DASHED_DIVIDER_HORIZONTAL_CLASSES = "border-t-2 border-dashed border-border w-full";

/** Web: vertical dashed divider base classes (DashedDivider.web) */
export const DASHED_DIVIDER_VERTICAL_CLASSES = "border-l-2 border-dashed border-border h-full";

/** Web: dashed border for drop zones / panels (border-2) */
export const DASHED_BORDER_BOX_NEUTRAL_300 = "border-2 border-dashed border-border";
export const DASHED_BORDER_BOX_GRAY_200 = "border-2 border-dashed border-border";
export const DASHED_BORDER_BOX_GRAY_300 = "border-2 border-dashed border-border";
...
export const DOTTED_BORDER_LIGHT_GRAY = "border-2 border-dotted border-neutral-300";
