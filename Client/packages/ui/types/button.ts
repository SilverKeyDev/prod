...
const FILLED_PRIMARY =
  "bg-primary text-white shadow-sm hover:bg-primary-hover hover:shadow active:bg-primary-hover focus-visible:ring-neutral-400 disabled:bg-disabled disabled:text-text-disabled disabled:shadow-none";
const FILLED_TERTIARY =
  "bg-accent text-white shadow-sm hover:bg-accent-hover hover:shadow active:bg-accent-hover focus-visible:ring-neutral-400 disabled:bg-disabled disabled:text-text-disabled disabled:shadow-none";
const FILLED_DANGER =
  "bg-destructive text-white shadow-sm hover:bg-destructive-hover hover:shadow active:bg-destructive-hover focus-visible:ring-neutral-400 disabled:bg-disabled disabled:text-text-disabled disabled:shadow-none";
