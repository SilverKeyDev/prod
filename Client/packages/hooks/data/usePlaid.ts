...
export function usePlaidLinkToken(): UsePlaidLinkTokenReturn {
  ...
  return {
    ...
    linkTokenError:
      linkTokenError?.message ?? createLinkTokenMutation.error?.message ?? null,
    createLinkToken,
  };
}
...
export function usePlaidAssetReports(): UsePlaidAssetReportsReturn {
  ...
  const createAssetReport = useCallback(
  ...
  return {
    assetReports,
    assetReportsLoading:
      assetReportsLoading || createAssetReportMutation.isPending,
    assetReportsError:
      assetReportsError?.message ??
      createAssetReportMutation.error?.message ??
      null,
    createAssetReport,
    refetchAssetReports,
  };
 ...
 */
export function usePlaidAssetReport(
  assetReportToken: string | null,
): UsePlaidAssetReportReturn {
  const {
    data: assetReport,
