 ...
 */
function transformApiBillingToSchema(
  apiBilling: ApiBillingInfo | null,
): SchemaBillingInfo | null {
  if (!apiBilling) {
    return null;
  }
  ...
  return {
    subscription: apiBilling.has_subscription
      ? {
          ...
          subscription_id: null, // Not available in API response
          plan: {
...
/**
 * Hook that integrates billing payment with useBillingStore
