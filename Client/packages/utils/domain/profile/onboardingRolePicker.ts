...
/** Roles shown on the first onboarding screen (includes coming-soon tiles). */
export type OnboardingRolePickerValue = "buyer" | "seller" | "agent" | "integration_partner";
...
export const ONBOARDING_ROLE_PICKER_OPTIONS: OnboardingRolePickerOption[] = [
  ...
  { value: "seller", label: FIELD_LABELS.ONBOARDING_ROLE_SELLER, enabled: false },
  {
