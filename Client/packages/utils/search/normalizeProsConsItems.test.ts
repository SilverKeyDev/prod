...
describe("normalizeConEntry", () => {
  it("maps legacy string to warning", () => {
  ...
  it("preserves red_flag", () => {
    expect(
      normalizeConEntry({ text: "Leak", severity: "red_flag", score: 4 }),
    ).toEqual({
      text: "Leak",
      severity: "red_flag",
      score: 4,
  ...
  it("normalizes redflag alias and unknown severity", () => {
    expect(
      normalizeConEntry({ text: "a", severity: "redflag", score: 2 }),
    ).toEqual({
      text: "a",
      severity: "red_flag",
      score: 2,
    ...
    expect(
      normalizeConEntry({ text: "b", severity: "other", score: 2 }),
    ).toEqual({
      text: "b",
      severity: "warning",
      score: 2,
