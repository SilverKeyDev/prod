...
export function homeDescriptionToSearchResult(
  ...
  const bedrooms =
    typeof home.bedrooms === "number" && Number.isFinite(home.bedrooms)
      ? home.bedrooms
      : 0;
  const bathrooms =
    typeof home.bathrooms === "number" && Number.isFinite(home.bathrooms)
      ? home.bathrooms
      : 0;
  const sqft =
    typeof home.sqft === "number" && Number.isFinite(home.sqft) && home.sqft > 0
      ? home.sqft
      : 0;
