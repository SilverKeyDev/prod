...
/**
 * Formats a number as compact count (e.g., 1.2k, 4.2M).
 * Use for likes, comments, and other non-currency counts.
 * Re-exported from compactCount for backwards compatibility.
 */
export { formatCompactNumber } from "./compactCount";
