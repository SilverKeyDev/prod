/**
 * RESPA: Brokerage-configured Move Concierge checklist embed URL builder; partner pays
 * platform placement (revenue share), not per-buyer agent referral fees. Prefill is
 * transaction/workflow context only — exposure should be logged at embed open surfaces.
 *
