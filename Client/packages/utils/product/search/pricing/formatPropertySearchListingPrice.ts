...
export function formatPropertySearchListingPrice(
  ...
  if (typeof property.listPrice === "string" && property.listPrice.trim() !== "") {
    return property.listPrice.trim();
  }
  if (typeof property.list_price === "string" && property.list_price.trim() !== "") {
    return property.list_price.trim();
  }
  if (typeof property.listing_price === "string" && property.listing_price.trim() !== "") {
