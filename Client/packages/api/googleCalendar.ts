...
export const googleCalendarApi = {
   ...
   */
  revokeAccess: async (): Promise<GoogleCalendarApiResponse<{ ok: boolean }>> => {
    try {
      const response = await apiPost<GoogleCalendarApiResponse<{ ok: boolean }>>(
   ...
   */
  listCalendars: async (): Promise<GoogleCalendarApiResponse<GoogleCalendarListResponse>> => {
    try {
      const response = await apiGet<GoogleCalendarApiResponse<GoogleCalendarListResponse>>(
  ...
  listEvents: async (params?: {
    ...
    try {
      ...
      const response = await apiGet<GoogleCalendarApiResponse<GoogleEventListResponse>>(url);
      return response;
    } catch (error) {
      return {
        success: false,
  ...
  createEvent: async (
    ...
    try {
      const response = await apiPost<GoogleCalendarApiResponse<GoogleEventCreateResponse>>(
  ...
  updateEvent: async (
    ...
    try {
      ...
      const response = await apiPatch<GoogleCalendarApiResponse<GoogleEventCreateResponse>>(
  ...
  deleteEvent: async (
    ...
    try {
      ...
      const response = await apiDelete<GoogleCalendarApiResponse<{ ok: boolean }>>(
   ...
   */
  createCalendar: async (name: string): Promise<GoogleCalendarApiResponse<GoogleCalendar>> => {
    try {
  ...
  addCalendarAcl: async (
    ...
    try {
      ...
      return {
        success: false,
        error: error instanceof Error ? error.message : "Failed to add calendar ACL",
      };
    }
  },
  ...
  clearConnectionStatus: (): void => {
    document.cookie = "google_calendar_connected=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";
  },
};
