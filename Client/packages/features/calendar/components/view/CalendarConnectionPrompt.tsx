    ...
    <Box className="border-border bg-background-base w-full rounded-xl border p-6">
      <Box className="flex flex-col items-center justify-center text-center sm:py-2">
        ...
        <Text className="text-text-primary mb-2 text-base font-semibold sm:text-lg">
          {isReconnect ? "Reconnect Your Google Calendar" : "Connect Your Google Calendar"}
        </Text>
        <Text className="text-text-secondary mb-6 max-w-md text-sm">
          {isReconnect
            ? "Your Google Calendar connection expired. Reconnect to continue syncing."
            : "Sync your Google Calendar to view your upcoming events and appointments directly on your dashboard."}
        </Text>
        <Pressable
          onPress={onConnect}
          disabled={isLoading}
