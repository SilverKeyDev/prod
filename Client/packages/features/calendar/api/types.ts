...
export type GoogleCalendarListResponse =
  components["schemas"]["GoogleCalendarListResponse"];
export type GoogleEventListResponse =
  components["schemas"]["GoogleEventListResponse"];
export type GoogleEventCreateResponse =
  components["schemas"]["GoogleEventCreateResponse"];
...
export type GoogleCalendarApiResponse<T = unknown> = Omit<
  ...
  "data"
> & { data?: T };
export type GoogleCalendarPermission =
  components["schemas"]["GoogleCalendarPermission"];
