      ...
      <div className="flex items-end gap-2 sm:gap-3">
        ...
        <div className="flex flex-1">
          <AutoExpandingTextarea
            ...
            minHeight={44}
            maxHeight={120}
            className="focus:border-brand-accent focus:ring-brand-accent/20 rounded-lg border-gray-200 bg-white text-sm transition-colors duration-150 focus:outline-none focus:ring-2 sm:text-base"
          />
        </div>
        ...
        <Button
          ...
          className="h-11 flex-shrink-0 px-4 transition-all duration-150 ease-out hover:shadow-md active:scale-95 disabled:scale-95 disabled:opacity-50"
        >
