...
type PropertyInfoProps = PropertyComponentProps;
...
export const PropertyInfo: React.FC<PropertyInfoProps> = ({ property }) => {
  ...
  const listingStatusCombined =
    propertyRecord.listingStatus ??
    propertyRecord.listing_status ??
    propertyRecord.homeStatus;
  const listingStatusRaw =
    typeof listingStatusCombined === "string"
      ? listingStatusCombined.trim()
      : undefined;
  ...
  const previousListPrice =
    "previousListPrice" in property
      ...
      : undefined;
  const daysOnMarket =
    "daysOnMarket" in property
      ? (property.daysOnMarket as number | undefined)
      : undefined;
  const propertySqft =
    "sqft" in property
