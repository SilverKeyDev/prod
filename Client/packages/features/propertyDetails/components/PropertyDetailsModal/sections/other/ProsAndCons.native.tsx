  ...
  return (
    <Box className="p-6">
      <Box className="mb-4 flex-row items-center gap-2">
        ...
        <Text className="text-text-secondary text-lg font-semibold">Pros & Cons</Text>
          ...
          <Box className="gap-3">
            {pros && pros.length > 0 ? (
              ...
              <Box className="flex-row items-center gap-2">
                ...
                <Text className="text-text-secondary text-sm">No pros identified</Text>
              </Box>
            )}
          </Box>
        </Box>
          ...
          <Box className="gap-3">
            {cons && cons.length > 0 ? (
              ...
              <Box className="flex-row items-center gap-2">
                ...
                <Text className="text-text-secondary text-sm">No cons identified</Text>
              </Box>
            )}
          </Box>
        </Box>
