...
export const PropertyDetailsBody: React.FC<PropertyDetailsBodyNativeProps> = ({
  ...
  const derived = useMemo(() => {
    ...
    return {
      ...
      price: getPrice(p),
      bedrooms: getNumericField(p, "bedrooms"),
      bathrooms: getNumericField(p, "bathrooms"),
      sqft: getNumericField(p, "sqft"),
    };
  }, [property]);
  ...
  return (
    <ScrollView className="flex-1" contentContainerStyle={styles.scrollContent}>
      ...
      <Box className="mt-2 flex-row flex-wrap items-center gap-2 px-4">
        <ConnectedCardHeartSave property={property} size="sm" />
