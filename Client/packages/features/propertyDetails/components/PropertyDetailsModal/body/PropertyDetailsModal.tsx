...
import { buildPropertyDetailsOrderedSections } from "packages/features/propertyDetails/components/PropertyDetailsModal/helpers/propertyDetailsModalSectionHelpers";
...
const PropertyDetailsModal: React.FC<PropertyDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="scrollbar-styled relative max-h-[90vh] w-full max-w-6xl overflow-y-auto overflow-x-hidden rounded-lg bg-white shadow-xl">
        <PropertyHeader
        ...
        {hasFeatures && <PropertyFeatures key="propertyFeatures" property={nonNullProperty} />}
