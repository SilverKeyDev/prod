...
import { PropertyAnalysis } from "packages/features/propertyDetails/components/PropertyDetailsModal/body/PropertyAnalysis.native";
import { PropertyDetails } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/info/PropertyDetails.native";
import { PropertyFeatures } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/info/PropertyFeatures.native";
import { PropertyInfo } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/info/PropertyInfo.native";
import { PropertyCommute } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/location/PropertyCommute.native";
import { PropertyNeighborhood } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/location/PropertyNeighborhood.native";
import { PropertySchools } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/location/PropertySchools.native";
import { ProsAndCons } from "packages/features/propertyDetails/components/PropertyDetailsModal/sections/other/ProsAndCons.native";
...
export type PropertyDetailsBodyNativeProps = PropertyComponentProps & {
  isLoading?: boolean;
};

export const PropertyDetailsBody: React.FC<PropertyDetailsBodyNativeProps> = ({
  property,
  isLoading = false,
}) => {
