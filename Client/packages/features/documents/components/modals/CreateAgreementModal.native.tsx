...
export default function CreateAgreementModalNative({
  isOpen,
  onClose,
  preselectedBuyerId,
  onSuccess,
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={handleClose}
      title={t("documents_create.title", {
        ...
        <Box className="gap-4">
          ...
          <Box className="gap-2">
            <Text className="text-sm font-medium text-gray-900">
              {t("documents_create.field_title", {
          ...
          <Box className="gap-2">
            <Text className="text-sm font-medium text-gray-900">
              {t("documents_create.field_buyer", {
                defaultValue: "Buyer",
              })}
              <Text className="text-rose-500"> *</Text>
            </Text>
            ...
            {!preselectedBuyerId && (
              ...
              >
                <Text className="text-xs font-medium text-gray-900">
                  {showBuyerList
                    ? t("documents_create.hide_buyers", {
                        defaultValue: "Hide buyers",
                      })
                    : t("documents_create.show_buyers", {
              ...
              <Box className="mt-2 max-h-40 gap-1 rounded-lg border border-gray-200 bg-gray-50 p-2">
                {clients.length === 0 ? (
                  <Text className="text-xs text-gray-600">
                    {t("documents_create.no_buyers", {
                      defaultValue: "No buyers available.",
                    })}
                  </Text>
                ) : (
                  clients.map((client) => (
          ...
          <Box className="mt-2 flex flex-row justify-end gap-3">
            ...
            >
              <Text className="text-sm font-medium text-white">
                {isCreatingAgreement
                  ? t("documents_create.submitting", {
                      defaultValue: "Creating...",
                    })
                  : t("documents_create.submit", {
                      defaultValue: "Create Agreement",
                    })}
              </Text>
            </Button>
