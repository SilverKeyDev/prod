...
function normalizeStatus(
  status: string,
): AgreementStatus | ContextualAgreementStatus | null {
...
const SIZE_CLASSES: Record<
  NonNullable<AgreementStatusBadgeProps["size"]>,
  string
> = {
  xs: "px-1.5 py-0",
...
export function AgreementStatusBadge({
  ...
  return (
    ...
    >
      {showIcon ? (
        <IconComponent className="h-3 w-3 shrink-0 opacity-80" aria-hidden />
      ) : null}
