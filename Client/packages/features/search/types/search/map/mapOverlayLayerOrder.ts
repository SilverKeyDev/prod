...
export type SearchMapOverlayLayer = (typeof SEARCH_MAP_OVERLAY_LAYER_ORDER)[number];

const LAYER_STEP = 1000;

export function searchMapOverlayBaseZIndex(layer: SearchMapOverlayLayer): number {
