...
import { writePersistedActiveWorkspace } from "packages/utils/product/workspace/workspaceSessionStorage";
...
export function useSetCurrentUserDevWorkspaceMutation() {
  ...
  const markServerIdentityTouched = useDevAppPersonaStore((s) => s.markServerIdentityTouched);
