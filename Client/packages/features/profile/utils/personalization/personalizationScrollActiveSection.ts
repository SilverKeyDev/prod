 ...
 * Shared by Settings and ProfileFeature sidebar highlighting.
 */
export function computePersonalizationActiveSectionId(
...
export function scrollToPersonalizationSection(sectionId: string): void {
