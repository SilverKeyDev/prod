...
import CompCard, { type CompData } from "packages/features/negotiate/components/layout/CompCard";
  ...
  return (
    <Box className="my-responsive-lg">
      ...
      <CardCarousel
        ...
        renderItem={(comp) =>
          comp && typeof comp === "object" ? <CompCard comp={comp as unknown as CompData} /> : null
        }
        getItemKey={(comp) =>
          comp &&
          typeof comp === "object" &&
