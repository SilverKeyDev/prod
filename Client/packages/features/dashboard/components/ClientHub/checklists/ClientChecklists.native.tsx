...
type ClientChecklistsNativeProps = {
  userId: string;
};

export function ClientChecklistsNative({ userId: _userId }: ClientChecklistsNativeProps) {
...
export default ClientChecklistsNative;
