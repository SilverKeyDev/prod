...
import SearchFiltersPanel from "@/features/search/filters/SearchFiltersPanel.web";
        ...
        <div className="fixed inset-0 flex items-end justify-center p-0 pointer-events-none">
          ...
          >
            ...
            >
              ...
              <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 pb-16 scrollbar-styled">
                <SearchFiltersPanel
                  formData={formData}
