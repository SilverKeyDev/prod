  ...
  return (
    <Transition show={isOpen} as="div">
      ...
      >
        ...
        <div className="fixed inset-0 flex items-end justify-center p-0 pointer-events-none">
          <Transition.Child
            enter="ease-out duration-200"
                      ...
                      <li key={comment.id} className="flex gap-3 px-4 py-3">
                        <div className="shrink-0">
                          {comment.user.avatarUrl ? (
                            ...
                            <div
                              className={`h-8 w-8 rounded-full bg-neutral-200 ${FEED_AVATAR_IMAGE_CLASS}`}
                            />
                          )}
                        </div>
              ...
              {item && (
                <div className="flex shrink-0 items-center gap-2 border-t border-neutral-200 px-4 py-3">
                  {currentUser?.avatarUrl ? (
                    ...
                    <div
                      className={`h-8 w-8 shrink-0 rounded-full bg-neutral-200 ${FEED_AVATAR_IMAGE_CLASS}`}
                    />
                  )}
                  <AccessibleTextInput
                    value={draft}
                  ...
                  <Button
                    ...
                    className={
                      canPost
                        ? "text-brand-accent font-semibold hover:bg-transparent hover:text-brand-accent/80"
