...
import type { PostData } from "packages/schemas/content/feed/feed";
        ...
        >
          {Array.from({ length: totalSlides }, (_, i) => (
            <Button
              ...
              className="h-1.5 w-1.5 rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
              style={{
                backgroundColor:
                  i === selectedIndex
