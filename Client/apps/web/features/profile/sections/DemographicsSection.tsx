...
import { BodyText, Dropdown, Input, Title } from "@/components/ui/index.web";
...
import ProfilePictureUpload from "@/features/profile/ProfilePictureUpload";
    ...
    <>
      ...
      <div>
        ...
        {isEditMode ? (
          ...
          <div className="mobile-input mt-2 bg-gray-50">
