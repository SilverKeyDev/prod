...
import { Dropdown, Input } from "@/components/ui/index.web";
          ...
          },
          {
            ...
            content: isEditMode ? (
              <PriceRangeSlider
                ...
                onChange={(val) => updateFormData("days_on_market_max", val)}
              ...
              <div className="mobile-input bg-gray-50">
                {formData.days_on_market_max != null
                  ? `Up to ${formData.days_on_market_max} days`
                  : "Not specified"}
              </div>
            ),
          },
        ...
        items={[
          {
            ...
            content: isEditMode ? (
              <PriceRangeSlider
                ...
                onChange={(val) =>
                  updateFormData("preferred_home_age_max", val)
                }
