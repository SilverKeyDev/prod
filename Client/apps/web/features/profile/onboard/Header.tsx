                        ...
                        <div className="relative flex justify-center overflow-visible">
                          <AnimatePresence initial={false} mode="wait">
                            <motion.span
                              ...
                              className={`hidden max-w-16 text-center text-xs leading-tight tracking-tight text-black/60 sm:block sm:max-w-18 sm:text-xs md:max-w-24 md:text-xs lg:max-w-28 lg:text-xs xl:max-w-32 xl:text-xs 2xl:text-xs ${isActive ? "font-medium" : "font-normal"} mt-1.5 sm:mt-2`}
                              initial={{
