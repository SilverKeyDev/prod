...
import type { GoogleMapsWindow } from "packages/schemas/integrations/google-maps";
            ...
            >
              <div className="min-w-0 flex-1 space-y-1">
                ...
                {location.commute_tolerance != null && (
                  <BodyText as="span" size="xs" className="block text-brown">
                  ...
                  {suggestions.map((s, idx) => (
                    <li key={idx}>
                      <Button
                        ...
                        className="w-full cursor-pointer px-3 py-2 text-left text-sm hover:bg-gray-100 justify-start"
                      >
                        {s.description}
                      </Button>
                    </li>
