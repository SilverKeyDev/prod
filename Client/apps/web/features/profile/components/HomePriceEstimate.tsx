...
const HomePriceEstimate: React.FC<HomePriceEstimateProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <Title as="h3" size="md" className="font-medium text-olive sm:text-lg">
          ...
          {homePriceLoading ? (
            ...
            <div className="space-responsive-sm">
              ...
              <div className="text-responsive-xs rounded border border-olive/30 bg-white px-2 py-3 text-black sm:p-3">
                <div className="space-y-1 overflow-x-auto rounded bg-beige/20 bg-opacity-20 px-2 py-2 font-mono text-black sm:space-y-2 sm:p-3 sm:text-xs">
                  ...
                  {homePriceResult.monthlyPMI > 0 && (
                    <>
                      ...
                      <BodyText
                        as="p"
                        size="xs"
                        className="ml-2 text-tiny sm:ml-4 sm:text-xs"
                      >
                        PMI Rate ≈{" "}
                        {(
