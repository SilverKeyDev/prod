...
import { BodyText, RangeInput } from "@/components/ui/index.web";
        ...
        <div className="mb-4 sm:mb-6">
          <div className="relative h-2">
            ...
            <RangeInput
              ...
              className={`pointer-events-none absolute h-2 w-full touch-manipulation appearance-none rounded-lg bg-transparent accent-white [&::-webkit-slider-thumb]:pointer-events-auto [&::-moz-range-thumb]:pointer-events-auto ${
