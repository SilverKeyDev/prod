    ...
    >
      <Section title="Get in Touch">
        <Paragraph className="space-y-responsive-md">
          ...
          need technical support, or want to provide feedback, we'd love to hear
          from you.
        </Paragraph>
      </Section>
          ...
          <div className="gap-responsive-sm flex items-start">
            ...
            <div>
              <Title
                as="h3"
                size="sm"
                className="space-y-responsive-xs font-semibold text-black"
              >
                Email
              </Title>
              <BodyText
        ...
        <div className="space-y-responsive-sm">
          <div>
            ...
            <BodyText
              as="p"
              size="sm"
              className="space-y-responsive-sm text-gray-600 text-responsive-sm"
            >
              Most reports are generated within 2-5 minutes. Complex properties
              or high-demand periods may take up to 15 minutes.
            </BodyText>
          </div>
          ...
          <div>
            ...
            <BodyText
              ...
              className="space-y-responsive-sm text-gray-600 text-responsive-sm"
            >
              We provide comprehensive property reports for all 50 US states,
              covering residential, commercial, and investment properties, with
              solid but slightly less accurate coverage globally.
            </BodyText>
          </div>
          ...
          <div>
            ...
            >
              ...
              completely satisfied with your report, contact us for a full
              refund.
            </BodyText>
          </div>
        </div>
      ...
      <Section title="Send Us a Message" isLast={true}>
        ...
        <Paragraph className="text-responsive-sm text-gray-600">
          ...
          so we can provide you with the most helpful response.
        </Paragraph>
      </Section>
    </StaticPageLayout>
  );
