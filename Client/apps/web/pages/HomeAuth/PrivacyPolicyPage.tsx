  ...
  return (
    <StaticPageLayout title="Privacy Policy" subtitle="Last updated: 8/27/2025">
      <Section title="1. Introduction">
        <Paragraph>
          Welcome to SilverKey. We respect your privacy and are committed to
      ...
      <Section title="2. Data We Collect">
        ...
        <List>
          ...
          <li>
            ...
            address, browser type and version, and other technology on the
      ...
      <Section title="3. How We Use Your Data">
        ...
        <List>
          ...
          <li>
            To improve our website, products/core/services, and customer
            relationships.
          </li>
        </List>
      </Section>
      ...
      <Section title="4. Data Security">
        <Paragraph>
          ...
          employees and other staff who have a business need to know.
        </Paragraph>
      </Section>
      ...
      <Section title="5. Your Legal Rights" isLast={true}>
        ...
        <Paragraph>
          ...
          contact us at{" "}
          <EmailLink href="mailto:privacy@silverkey.com">
            privacy@silverkey.com
          </EmailLink>
          .
        </Paragraph>
      </Section>
