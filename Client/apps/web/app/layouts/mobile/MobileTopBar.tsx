...
type MobileTopBarProps = {
  ...
  fullWidth?: boolean;
  /** When true, remove left/right padding (e.g. when MobileBottomNav is visible and content should align edge-to-edge) */
  noPadding?: boolean;
};
...
const MobileTopBar: React.FC<MobileTopBarProps> = ({
  ...
  return (
    <>
      <div
        ref={containerRef}
        className={`bg-background fixed left-0 right-0 top-0 z-40 transition-all duration-300 ease-in-out md:hidden ${
