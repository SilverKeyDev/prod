...
const BaseCard = forwardRef<HTMLDivElement, BaseCardProps>(
  (
    ...
    const getWidthStyles = (width: string) => {
      ...
      return (
        widthStyles[width as keyof typeof widthStyles] ?? widthStyles.standard
      );
    };
    ...
    const getHeightStyles = (height: string) => {
      ...
      return (
        heightStyles[height as keyof typeof heightStyles] ?? heightStyles.auto
      );
    };
