...
import {
  ...
  getPdfIframeSandbox,
  getPdfViewerStyles,
} from "packages/utils/domain/documents/pdf";
    ...
    >
      {isMobile && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/95 p-6 text-center sm:hidden">
          <div className="mb-4">
            <svg
              className="mx-auto h-16 w-16 text-olive"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <Button
            ...
            className="group flex items-center gap-2 bg-gradient-to-r from-gold to-gold/90 font-semibold text-white shadow-lg transition-all duration-200 hover:from-gold/90 hover:to-gold/80 hover:shadow-xl active:scale-95"
          >
