import { Button, Title } from "@ui/index.web";
      ...
      <PropertyCard
        ...
        topContent={
          <div className="flex items-center justify-between">
            <CardHeartSave property={toCardProperty(home)} size="sm" />
            <Button
              type="button"
              variant="ghost"
              onClick={(e) => {
              ...
              className="group relative inline-flex h-9 w-9 items-center justify-center rounded-full bg-white shadow-md ring-1 ring-black/5 transition-all duration-300 hover:scale-110 active:scale-95 text-gray-400 hover:text-gray-600"
