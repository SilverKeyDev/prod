...
> = {
  sm: {
    container: "text-xs sm:text-sm text-gray-500",
    icon: "w-2.5 h-2.5 sm:w-3 sm:h-3 text-gray-400 flex-shrink-0 mr-1",
  },
  md: {
    container: "text-sm sm:text-base text-gray-500",
 ...
 * Renders optional icon + muted gray text using BodyText.
 */
export default function PropertyStat({
  ...
  return (
    <div
      className={`flex flex-shrink-0 items-center ${styles.container} ${className}`.trim()}
    >
      {iconWithClass}
      <BodyText
        as="span"
