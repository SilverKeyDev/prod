...
class TestResolveCreateEventTarget:
    ...
    @patch("app.services.calendar.events.creation.user_is_agent", return_value=True)
    def test_agent_creates_for_self(self, _mock_is_agent, mock_agent_user):
    ...
    def test_agent_creates_for_client_valid(self, mock_validate, _mock_is_agent, mock_agent_user):
    ...
    @patch("app.services.calendar.events.creation.user_is_agent", return_value=True)
    @patch("app.services.calendar.events.creation.validate_agent_client_relationship")
    def test_agent_creates_for_invalid_client(self, mock_validate, _mock_is_agent, mock_agent_user):
    ...
    @patch("app.services.calendar.events.creation.user_is_agent", return_value=False)
    @patch("app.services.calendar.events.creation.get_user_agent_id")
    def test_client_creates_for_self_with_agent(
        self, mock_get_agent_id, _mock_is_agent, mock_client_user
    ):
    ...
    @patch("app.services.calendar.events.creation.user_is_agent", return_value=False)
    @patch("app.services.calendar.events.creation.get_user_agent_id")
    def test_client_creates_for_self_no_agent(
        self, mock_get_agent_id, _mock_is_agent, mock_client_user_no_agent
    ):
    ...
    @patch("app.services.calendar.events.creation.user_is_agent", return_value=False)
    @patch("app.services.calendar.events.creation.get_user_agent_id")
    def test_client_creates_for_agent(self, mock_get_agent_id, _mock_is_agent, mock_client_user):
    ...
    @patch("app.services.calendar.events.creation.user_is_agent", return_value=False)
    @patch("app.services.calendar.events.creation.get_user_agent_id")
    def test_client_creates_for_invalid_agent(
        self, mock_get_agent_id, _mock_is_agent, mock_client_user
    ):
    ...
    def test_agent_creates_for_client_with_agent_calendar_flag(
        self, mock_validate, _mock_is_agent, mock_agent_user
    ):
