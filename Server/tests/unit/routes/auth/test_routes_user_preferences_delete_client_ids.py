"""DELETE /api/v1/preferences when agent client_ids JSON links clients (legacy path)."""
...
class TestPreferencesDeleteClientIds:
    """Delete flows using agent.client_ids JSON (distinct from AgentConnections auth tests)."""
