...
#   timestamp: 2026-04-18T05:44:04+00:00
...
class ViewingItinerary(BaseModel):
    """
    Ordered viewing stops with optional computed route legs.
    """
    ...
    ordered: bool | None = Field(
        False, description="True when stops were optimized via the route service."
    )
...
class GoogleCalendarEventCreateBody(GoogleEvent):
    """
    Alias of GoogleEvent for event creation
    """
