...
def batch_cosine_similarity(user_embedding: np.ndarray, home_embeddings: List[np.ndarray]) -> List[float]:
...
def rank_by_similarity(
    ...
    try:
        ...
        paired = list(zip(items, similarities))
...
class SimilarityCalculator:
    ...
    def calculate_multiple(
        ...
        if method == "cosine":
            ...
            return [
                self.calculate(user_embedding, home_emb, method) 
                for home_emb in home_embeddings
            ]
