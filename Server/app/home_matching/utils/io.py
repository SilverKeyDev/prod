...
def load_user_data(file_path: Union[str, Path]) -> Dict[str, Any]:
...
def load_home_data(file_path: Union[str, Path]) -> Dict[str, Any]:
...
def load_multiple_homes(directory: Union[str, Path]) -> List[Dict[str, Any]]:
