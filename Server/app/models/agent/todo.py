...
class Todo(db.Model):
    ...
    client_id = db.Column(db.String(36), db.ForeignKey('users.id'), nullable=True)  # Optional: associated client
    ...
    type = db.Column(db.String(50), nullable=False, default='manual')  # deadline, follow_up, inspection, offer_expiration, closing, manual
