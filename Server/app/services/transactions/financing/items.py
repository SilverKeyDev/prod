"""Financing checklist task definitions."""

FINANCING_ITEMS = [
    {
        "id": 1,
        "label": "Finalize mortgage application & submit docs",
        "explanation": "Your lender needs detailed documentation to complete your mortgage. Submit everything promptly to avoid delays.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "Locks protect you from rate increases while your loan is processed. Timing matters.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "Once your documents are reviewed, the underwriter issues conditional or final approval — a key milestone.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "These documents explain your loan terms, closing costs, and final amount due. Compare them carefully.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "Homeowners insurance is required for financed homes. Compare coverage and premiums across providers.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "Standard homeowners insurance typically does not cover flood or earthquake damage.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "A binder is proof of active insurance and is required before funding. Your insurer can send it directly.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "You'll need to send funds for closing (down payment + closing costs) a day or two before signing.",
        "bullets": [
    ...
    },
    {
        ...
        "explanation": "Some title companies require or allow a cashier's check instead of a wire, especially for smaller amounts.",
        "bullets": [
