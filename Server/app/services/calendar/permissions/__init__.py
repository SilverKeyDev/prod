...
PERMISSION_SCOPE_MAP = {perm_name: perm_data['scope_url'] for perm_name, perm_data in permissions.items()}
PERMISSION_DESCRIPTIONS = {perm_name: perm_data['description'] for perm_name, perm_data in permissions.items()}
