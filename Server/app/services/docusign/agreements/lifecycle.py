...
from app import db
from app.models import Agreement, AgreementEvent, AgreementParticipant
...
class AgreementLifecycleService:
    ...
    def get_agreement(agreement_id: str) -> Agreement:
        """Get agreement by ID"""
        logger.debug(
            LOG_CATEGORIES["DOCUSIGN"], "Fetching agreement", {"agreement_id": agreement_id}
        )
    ...
    def send_for_signature(agreement_id: str, signing_method: str, actor_id: str):
        ...
        logger.debug(
            ...
            {"agreement_id": agreement_id, "signing_method": signing_method, "actor_id": actor_id},
        )
