...
class TemplateSyncService:
    ...
    def sync_all_templates():
        ...
        logger.debug(LOG_CATEGORIES["DOCUSIGN"], "Templates fetched from DocuSign", {
        ...
        for tmpl in templates:
            try:
                ...
                if existing:
                    # Update
                    logger.debug(LOG_CATEGORIES["DOCUSIGN"], "Updating existing template", {
                    ...
                    # Create
                    logger.debug(LOG_CATEGORIES["DOCUSIGN"], "Creating new template", {
                        "template_id": tmpl['templateId'],
                        "name": tmpl['name']
                    })
                ...
                logger.error(LOG_CATEGORIES["ERRORS"], "Failed to sync template", {
        ...
        logger.info(LOG_CATEGORIES["DOCUSIGN"], "Template sync completed successfully", {
