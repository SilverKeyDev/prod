...
from app.services.auth.user_roles_sync import (
    ...
    primary_onboarding_role_is_brokerage,
...
def write_preferences_from_payload(
    ...
    *,
    ...
    # Shell workspace roles: grant from primary_onboarding_role once (QA until invite flows ship)
    if primary_onboarding_role_is_brokerage(data) and not user_has_brokerage_admin(u):
        ensure_user_role(str(u.id), "brokerage_admin")
