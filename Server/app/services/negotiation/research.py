...
"""
        ...
        # Only strategy generation is supported for negotiation
        raise ValueError(f"Unsupported section_type for negotiation: {section_type}. Only 'strategy' or 'negotiation_strategy' are supported.")
...
# -------------------------------------------------
# Public: generate_report (for negotiation strategy generation)
# -------------------------------------------------
def generate_report(
    section_type: str,
    address: str,
