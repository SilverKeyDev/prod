...
class Affordability(BaseModel):
    ...
    long_term_costs: str = Field(...)
    projected_value: str = Field(...)
    ...
    def get_description(cls, user_preferences: dict[str, Any] | None = None) -> dict[str, str]:
        ...
        gross_income = (
            user_preferences.get("gross_income", "$50,000-$75,000")
            if user_preferences
            else "$50,000-$75,000"
        )
    ...
    def get_comparison_description(
        ...
        return {
            "affordability_rating": "Decimal rating (e.g., 8.5).",
            "monthly_payment": "Estimated monthly mortgage payment amount.",
            "projected_value": "Value trends and appreciation outlook.",
        }
