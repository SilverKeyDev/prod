...
For TypeScript-only (`.ts`) layout, see [typescript-files.md](../architecture/typescript-files.md). For overall frontend architecture and layer rules, see `.cursor/rules/frontend/frontend-architecture.mdc`.
