...
**Related:** [thin-app-architecture.md](../architecture/thin-app-architecture.md), [apps-folder-contents.md](../architecture/apps-folder-contents.md), [react-vs-react-native-packages.md](react-vs-react-native-packages.md).
