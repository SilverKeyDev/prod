...
Maps-specific setup: [`google-maps-web-setup.md`](./google-maps-web-setup.md).
...
3. Add GitHub secret and `--build-arg` in [`.github/workflows/ci_web.yml`](../../.github/workflows/ci_web.yml).
