...
**Related:** [responsive-ui-standards.md](responsive-ui-standards.md) (touch targets, form sizing), [LINTING.md](LINTING.md) (jsx-a11y + SilverKey a11y rules), [qa/ACCESSIBILITY_CHECKLIST.md](../qa/ACCESSIBILITY_CHECKLIST.md) (manual release pass).
...
| 1.4.3 Contrast (AA) | 4.5:1 normal text; 3:1 large text / UI components | Semantic tokens in [color-system.md](color-system.md); see contrast table below |
...
- **Manual:** [ACCESSIBILITY_CHECKLIST.md](../qa/ACCESSIBILITY_CHECKLIST.md) before release
