...
- **Automation:** `e2e/not-found.spec.ts` asserts main copy and home navigation.
...
- [ ] 404 in-app (automated + manual on each major browser)
...
- [ERROR_STATES.md](./ERROR_STATES.md)
