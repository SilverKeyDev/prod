...
Monorepo structure, import layers, workspaces, and package layout.
...
| [shared-packages.md](./shared-packages.md) | Exhaustive `Client/packages/` reference. |
| [typescript-files.md](./typescript-files.md) | Where `.ts` (non-TSX) files live by package. |
| [document-schema-naming.md](./document-schema-naming.md) | Document schema naming conventions. |
