...
Output path (per Vite config): **`Client/dist/bundle-stats.html`** (treemap; gzip/brotli sizes). Use it for axis 5 and fat-package triage. Broader Vite and web script layout: [config-files-reference.md](./config-files-reference.md).
...
- Responsive audit map: [responsive-ui-standards.md](./responsive-ui-standards.md)
- Lint gates including file size: [LINTING.md](./LINTING.md)
