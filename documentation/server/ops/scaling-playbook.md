...
- [ ] **Messaging SSE** — Redis pub/sub fan-out (see [`documentation/internal/messaging-sse-operations.md`](../../internal/messaging-sse-operations.md)).
...
- [infrastructure-reliability-gap-audit.md](../infrastructure-reliability-gap-audit.md)
