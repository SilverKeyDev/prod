...
**Related:** [thin-app-architecture.md](../architecture/thin-app-architecture.md), [apps-folder-contents.md](../architecture/apps-folder-contents.md), [react-vs-react-native.md](../architecture/platform/react-vs-react-native.md).
...
- Add the chosen package to `Client/apps/mobile/package.json`; wrap screens or scroll areas that contain text inputs with the library’s component. See [platformVariants/keyboard-handling.md](../reference/platform-variants/keyboard-handling.md) for implementation details.
