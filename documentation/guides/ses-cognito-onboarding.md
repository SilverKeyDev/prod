...
Start DMARC at `p=none`; move to `quarantine` / `reject` after monitoring (see [email-deliverability.md](../runbooks/qa/email-deliverability.md)).
...
Pool: **`prod-silverkey-users`** (see [aws-resources.md](../reference/aws-resources.md)).
...
Repeat with Gmail, Outlook, and iCloud if possible ([deliverability QA](../runbooks/qa/email-deliverability.md)).
...
- [aws-resources.md](../reference/aws-resources.md) — Cognito, IAM, Secrets Manager
- [email-deliverability.md](../runbooks/qa/email-deliverability.md) — SPF/DKIM/DMARC QA
