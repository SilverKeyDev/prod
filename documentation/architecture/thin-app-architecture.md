...
- **Package layout and imports:** `documentation/architecture/shared-packages.md` and `Client/packages/README.md`.
- **Web + mobile parity gotchas:** [web-mobile-parity.md](../guides/web-mobile-parity.md) — stale app/schemas, React version, deep linking.
