...
Celery handles async work off the Flask request path. Redis is broker and result backend — see [ops/redis-celery.md](../runbooks/redis-celery.md).
...
- [ops/redis-celery.md](../runbooks/redis-celery.md)
