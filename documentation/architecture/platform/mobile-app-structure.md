...
This document describes the structure and purpose of each file in the React Native mobile app (`Client/apps/mobile/`). The app uses Expo, React Navigation, and shared packages from the monorepo.
...
- [Thin app architecture](../thin-app-architecture.md)
- [Shared packages](../shared-packages.md)
- [Web mobile parity gotchas](../../guides/web-mobile-parity.md) – differences and shared patterns between web and mobile.
