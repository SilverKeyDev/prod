...
- [Celery tasks](../architecture/celery-tasks.md) (task catalog)
- [Flask architecture](../architecture/flask-architecture.md)
- [Infrastructure gap audit](../guides/deployment.md)
