...
Use **Stripe test cards** for decline. Expect clear messaging and consistent subscription/entitlement state. See [flow-payments.md](./flow-payments.md).
...
- [error-pages-404-500.md](./error-pages-404-500.md) — in-app vs CDN errors
