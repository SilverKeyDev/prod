...
5. **Email:** open inbox for the sign-up address; confirm verification **email** arrived (see [email-deliverability.md](./email-deliverability.md)).
...
5. **Mobile Safari (web only):** if users can complete signup in **Safari on iOS** (marketing site or PWA), repeat the web steps on a **real device** (see [env-and-device-matrix.md](./env-and-device-matrix.md)).
...
- [end-to-end-qa-runbook.md](./end-to-end-qa-runbook.md) — execution order and scope.
