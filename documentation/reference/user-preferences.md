...
Schema changes bump `preferences_version` on write; the read pipeline maps by version and keeps the client backward-compatible.
...
- **API conventions:** `documentation/reference/api-conventions.md`
