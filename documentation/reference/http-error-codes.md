...
Canonical status and JSON envelope rules for `Server/app/routes/`. Telemetry classification: [`../runbooks/posthog/api-error-semantics.md`](../runbooks/posthog/api-error-semantics.md).
