...
- **Implementation:**
  ...
  - **Deep linking:** Configure React Navigation linking (and iOS Universal Links / Android App Links) so URL paths match web. Document path → screen mapping so web and mobile stay in parity (see [web-mobile-parity-gotchas.md](../../guides/web-mobile-parity.md)).
