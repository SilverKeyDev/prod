...
**Scope:** Dependencies listed in the app/root `package.json` files only — not shared-package internals. For shared code and file extensions (`.web` / `.native`), see [react-vs-react-native.md](../../architecture/platform/react-vs-react-native.md).
...
- [react-vs-react-native.md](../../architecture/platform/react-vs-react-native.md) — Platform extensions, shared packages, bundler resolution.
- [web-mobile-parity-gotchas.md](../../guides/web-mobile-parity.md) — React version, API versioning, deep linking.
