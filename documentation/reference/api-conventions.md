...
5. Implement the Flask handler with matching request/response shapes; add `@validate_request` / `@validate_response` per [input-validation.md](../guides/input-validation.md).

**Canonical workflow:** [openapi-workflow.md](../guides/openapi-workflow.md). Type usage: [`.cursor/rules/shared/openapi-types.mdc`](../../.cursor/rules/shared/openapi-types.mdc).
...
- **Flask architecture:** `documentation/architecture/flask-architecture.md`
