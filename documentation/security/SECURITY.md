...
- Input validation (OpenAPI + Pydantic — see [openapi-validation-rollout.md](../server/openapi-validation-rollout.md))
...
3. **Notify** — follow compliance docs ([compliance/](../compliance/)) for breach notification obligations.
...
| Doc | Topic |
|-----|-------|
| [PRIVACY_POLICY.md](../compliance/PRIVACY_POLICY.md) | Privacy |
| [GDPR.md](../compliance/GDPR.md) | GDPR |
| [DATA_RETENTION.md](../compliance/DATA_RETENTION.md) | Retention |
